...
% A/D
noised_recieved_signal = noised_signal.*cos(2*pi*f2*t + theta) - 1i*noised_signal.*sin(2*pi*f2*t + theta);
...
% reconstructed_digital_signal = downsample_with_another_symbol_rate(filtered_reconstructed_digital_signal, sampsPerSym, R, Rtag);
